{
  :'fr' => {
    :active_scaffold => {
      ...
      :revisions_for_model => 'Versions pour {{model}}',
      ...
      :version_inconsistency => "Version déjà modifiée - Cet enregistrement a été modifié depuis que vous avez commencé à l'éditer.",
    }
  }}
